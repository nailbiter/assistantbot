...
$client = MongoDB->connect(sprintf("mongodb+srv://%s:%s\@cluster0.gaq9o.mongodb.net/logistics?authSource=admin&replicaSet=atlas-1372ty-shard-0&w=majority","nailbiter",$mongoPassword));

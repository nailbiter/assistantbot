...
// (i.e., you'd see them in a stack trace between jshell.JShell
// and a command class such as jshell.command.ls):
...
// of a command line, and the reflect the structure of JShell syntax.
...
public class CommandLineInterpreter extends PooledThread
{
        ...
        throws Exception
    {
        ...
        if (exceptions.size() > 0)
            throw new JShellException(exceptions);
    }

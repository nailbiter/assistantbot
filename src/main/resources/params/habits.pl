...
makeHabit "0 21 * * mon,tue,wed,thu,fri", "drink protein", 3*60 , category=>"logistics";
...
makeHabit "0 7 * * *", "take vitamins", 60*6,category=>'logistics', onFailed=>"remove";
...
makeHabit "0 16 * * mon,tue,wed,thu,fri", "write daily report", 60, category=>"parttime";

...
makeHabit "0 15 * * *", "uncle vanya project", 1080, onFailed=> "move:FAILED",info=>'https://trello.com/c/qGE98nSa', enabled=>0;
makeHabit "0 16 * * mon", "dad english", 1080, onFailed=>'move:TODO' ;
makeHabit "30 23 * * *", "mental exercise", 1080, onFailed=>'move:FAILED2',enabled =>0;
...
makeHabit "30 7 * * *", "wash plates", 5*30,category=>'logistics',onFailed=>"remove";

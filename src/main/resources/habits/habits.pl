...
makeHabit "30 23 * * *", "mental exercise", 1080, onFailed=>'move2';
makeHabit "0 8 * * mon,tue", "sprint 4", 1380, category=> "gym" ;
makeHabit "0 8 * * mon", "long walk", 1380, category=> "gym" ;
...
makeHabit "15 22 * * Fri", "confucius 1h: 1", 960, onFailed=>'move2';
